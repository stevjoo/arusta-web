...
@section('title', 'Edit Photography')
...
<div class="max-w-4xl mx-auto mt-10 border-white border-2 bg-darkgray p-6 rounded-lg shadow-lg text-white">
    ...
    <form method="POST" action="{{ route('admin-photography.update', ['admin_photography' => $photo->id]) }}" enctype="multipart/form-data">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('admin-photography.index') }}" class="bg-gray-500 hover:bg-gray-700 px-4 py-2 rounded-lg font-medium text-white transition duration-200">
                Back to List
            </a>
        </div>
    </form>
