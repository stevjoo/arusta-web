...
@section('title', 'Admin Behind the Lense')
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="sm:p-3 md:p-6 bg-white border-b border-gray-200">
            <div class="my-5 me-3 flex justify-end">
                <a href="{{ route('admin-behind-the-lense.create') }}" class="px-3 py-2 sm:px-4 sm:py-2 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded-lg shadow transition duration-200">
                    Add New Photo
                </a>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="px-2 sm:px-5 py-2 sm:py-5 border-b border-gray-200 bg-white text-sm">
                                <div class="flex flex-wrap sm:gap-2">
                                    <a href="{{ route('admin-behind-the-lense.show', $photo->id) }}" class="px-3 py-2 rounded-lg bg-green-500 hover:bg-green-700 text-white transition duration-200 text-xs sm:text-sm">
                                        View
                                    </a>
                                    <a href="{{ route('admin-behind-the-lense.edit', $photo->id) }}" class="px-3 py-2 rounded-lg bg-blue-500 hover:bg-blue-700 text-white transition duration-200 text-xs sm:text-sm">
                                        Edit
                                    </a>
                                    <form action="{{ route('admin-behind-the-lense.destroy', $photo->id) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
