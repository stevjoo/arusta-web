                        ...
                        <tr class="odd:bg-neutral-800 even:bg-neutral-700">
                            ...
                            <td class="px-2 sm:px-5 py-2 sm:py-5 border-b border-gray-500 text-gray-300 text-sm">
                                <div class="flex flex-wrap sm:gap-2">
                                    ...
                                    <a href="{{ route('admin-behind-the-lense.edit', $photo->id) }}" class="px-3 py-2 rounded-lg bg-blue-600 hover:bg-blue-800 text-white transition duration-200 text-xs sm:text-sm">
                                        Edit
                                    </a>
